...
def UnetPP(input_shape, n_labels, using_deep_supervision=False):
    ...
    nb_filter = [i*2 for i in nb_filter]
    global bn_axis
    ...
    up3_2 = Conv2DTranspose(nb_filter[2], (2, 2), strides=(2, 2), name='up32', padding='valid')(conv4_1)
    up3_2_resized = resize(up3_2, (75, 200))
    conv3_2 = concatenate([up3_2_resized, conv3_1], name='merge32', axis=bn_axis)
    ...
    up4_2_resized = resize(up4_2, (37, 100))
    conv4_2 = concatenate([up4_2_resized, conv4_1], name='merge42', axis=bn_axis)
    conv4_2 = conv_batchnorm_relu_block(conv4_2, nb_filter=nb_filter[3])
    
    up3_3 = Conv2DTranspose(nb_filter[2], (2, 2), strides=(2, 2), name='up33', padding='same')(conv4_2)
    up3_3_resized = resize(up4_2, (75, 200))
    conv3_3 = concatenate([up3_3_resized, conv3_1, conv3_2], name='merge33', axis=bn_axis)
